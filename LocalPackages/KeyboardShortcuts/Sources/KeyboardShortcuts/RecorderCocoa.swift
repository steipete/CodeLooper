    ...
    public extension KeyboardShortcuts {
        ...
        final class RecorderCocoa: NSSearchField, NSSearchFieldDelegate {
            ...
            public required init(
                ...
                // Hide the cancel button when not showing the shortcut so the placeholder text is properly centered.
                // Must be last.
            ...
            public var shortcutName: Name {
                didSet {
                    ...
                    // This doesn't seem to be needed anymore, but I cannot test on older OS versions, so keeping it
                    // just in case.
            ...
            override public func viewDidMoveToWindow() {
                ...
                // This is especially important for Settings windows, which as of macOS 13.5, only hides instead of
                // closes when you click the close button.
            ...
            override public func becomeFirstResponder() -> Bool {
                ...
                eventMonitor = LocalEventMonitor(events: [.keyDown, .leftMouseUp, .rightMouseUp]) { [weak self] event in
                    ...
                    // The “shift” key is not allowed without other modifiers or a function key, since it doesn't
                    // actually work.
                    guard
                    ...
                    if let menuItem = shortcut.takenByMainMenu {
                        ...
                        NSAlert.showModal(
                            ...
                            title: String.localizedStringWithFormat(
                                "keyboard_shortcut_used_by_menu_item".localized,
                                menuItem.title
                            )
                        )
                    ...
                    if shortcut.isTakenBySystem {
                        ...
                        // If the user has selected "Use Anyway" in the dialog (the second option), we'll continue
                        // setting the keyboard shorcut even though it's reserved by the system.
