...
func testWindowControllerManagement() async throws {
    let mockLoginItemManager = createMockLoginItemManager()
    let mockSessionLogger = createMockSessionLogger()
    let mockDelegate = createMockWindowManagerDelegate()
...
func testWindowManagerDelegate() async throws {
...
func testWindowPositionManagerSingleton() async throws {
...
func testWindowPositionOperations() async throws {
...
func testPositionSavingAndRestoration() async throws {
    let manager = await WindowPositionManager.shared
...
func testAppleScriptSupportMethods() async throws {
    let manager = await WindowPositionManager.shared
...
func testUserDefaultsSerialization() async throws {
...
func testMonitoredWindowInfo() async throws {
...
func testWindowTitleParsing() async throws {
...
func testDocumentPathProcessing() async throws {
...
func testDisplayTextExtraction() async throws {
...
func testAsyncOperations() async throws {
    ...
    let indices = results.map { $0.0 }
    let processedStrings = results.map { $0.1 }
...
func testFrameCalculations() async throws {
...
private func createMockWindowManagerDelegate() -> MockWindowManagerDelegate {
    return MockWindowManagerDelegate()
}