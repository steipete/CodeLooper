...
struct HeartbeatMonitoringTests {
    ...
    struct InstanceInfoTests {
        ...
        func instanceInfoEquality(testCase: (
            pid1: pid_t,
            pid2: pid_t,
            shouldEqual: Bool,
            reason: String
    ...
    struct StatusTransitionTests {
        @Test(
            ...
            arguments: [
                ...
                (
                    from: .recovering(type: .stuck, attempt: 3),
                    to: .unrecoverable(reason: "Max attempts"),
                    isValid: true
                ),
        ...
        func statusTransitionValidation(transition: (
            from: CursorInstanceStatus,
            to: CursorInstanceStatus,
            isValid: Bool
        )) {
