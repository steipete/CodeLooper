...
struct AccessibilityTests {
    @Test("Permissions manager initialization") @MainActor func testPermissionsManagerInitialization() async throws {
    ...
    @Test("Permissions manager shared instance") @MainActor func testPermissionsManagerSharedInstance() async throws {
    ...
    @Test("Permissions manager permission check methods") @MainActor func testPermissionsManagerPermissionCheckMethods() async throws {
        let manager = PermissionsManager()
    ...
    @Test("Permissions manager request notification permissions") @MainActor func testPermissionsManagerRequestNotificationPermissions() async throws {
        let manager = PermissionsManager()
    ...
    @Test("Permissions manager observable object compliance") @MainActor func testPermissionsManagerObservableObjectCompliance() async throws {
        let manager = PermissionsManager()
    ...
    @Test("AX Permission helpers accessibility check") func testAXPermissionHelpersAccessibilityCheck() async throws {
    ...
    @Test("AX Permission helpers permission request") func testAXPermissionHelpersPermissionRequest() async throws {
    ...
    @Test("Permissions manager URL generation") @MainActor func testPermissionsManagerURLGeneration() async throws {
    ...
    @Test("Permissions manager permission state caching") @MainActor func testPermissionsManagerPermissionStateCaching() async throws {
        let manager = PermissionsManager()
    ...
    @Test("Permissions manager permission monitoring task") @MainActor func testPermissionsManagerPermissionMonitoringTask() async throws {
        let manager = PermissionsManager()
    ...
    @Test("Permissions manager permission request accessibility") @MainActor func testPermissionsManagerPermissionRequestAccessibility() async throws {
        let manager = PermissionsManager()
    ...
    @Test("Permissions manager multiple permission requests") @MainActor func testPermissionsManagerMultiplePermissionRequests() async throws {
        let manager = PermissionsManager()
    ...
    @Test("Permissions manager memory management") @MainActor func testPermissionsManagerMemoryManagement() async throws {
    ...
    @Test("Permissions manager published property updates") @MainActor func testPermissionsManagerPublishedPropertyUpdates() async throws {
        let manager = PermissionsManager()
    ...
    @Test("AX Permission helpers static method availability") func testAXPermissionHelpersStaticMethodAvailability() async throws {
