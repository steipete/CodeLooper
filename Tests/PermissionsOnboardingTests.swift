...
struct PermissionsOnboardingTests {
    ...
    func testPermissionsViewHandling() async throws {
    ...
    func testConcurrentOnboardingInteractions() async throws {
        let coordinator = OnboardingCoordinator()
    ...
    func testConcurrentPermissionChecking() async throws {
    ...
    func testOnboardingEdgeCases() async throws {
        let coordinator = OnboardingCoordinator()
