...
public enum Info: Sendable {
    ...
    public static let cfBundleIconFile: String = ""
    public static let cfBundleIdentifier: String = "me.steipete.codelooper"
    ...
    public static let cfBundleURLTypes: [[String: Sendable]] = [["CFBundleTypeRole": "Viewer", "CFBundleURLName": "me.steipete.codelooper", "CFBundleURLSchemes": ["codelooper"]]]
    ...
    public static let nsAppTransportSecurity: [String: Sendable] = ["NSAllowsArbitraryLoads": true]
    ...
    public static let nsPrincipalClass: String = "NSApplication"
}
