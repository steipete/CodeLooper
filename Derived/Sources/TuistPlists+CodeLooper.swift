...
public enum Info: Sendable {
    ...
    public nonisolated(unsafe) static let cfBundleURLTypes: [[String: Any]] = [["CFBundleTypeRole": "Viewer", "CFBundleURLName": "ai.amantusmachina.codelooper", "CFBundleURLSchemes": ["codelooper"]]]
